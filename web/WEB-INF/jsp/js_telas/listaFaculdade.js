 ...
 */
function deletaFaculdade(id) {

    apagaViaAjax('deleta-faculdade-adm?id=' + id, null, null,
            function (data) {
                criaCaixaMensagem("Sucesso ao Apagar", 4000, "info", null);
                setTimeout(function () {
                    $(location).attr('href', 'http://localhost:8084/SistemaDeViagensFrontEnd/lista-faculdades');
                }, 5000);
            }, function (data) {
