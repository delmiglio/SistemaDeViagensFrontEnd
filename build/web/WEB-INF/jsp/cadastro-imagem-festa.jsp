        ...
        <c:import url="barraDeNavegacao.jsp"></c:import>
            <div class="section no-pad-bot" id="index-banner">
                <div class="container">
                    ...
                    <br><br>
                    <div class="row">
                        <form name="frmFesta" id="frmFesta" action="salvar-imagem-festa" 
                            ...
                            <div class="col s6">
                                <div class="file-field input-field">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate" value="${festa.foto}" id="foto" name="foto" type="text" placeholder="Selecione uma Foto" />
                                </div>
                            </div> 
                        </div>
